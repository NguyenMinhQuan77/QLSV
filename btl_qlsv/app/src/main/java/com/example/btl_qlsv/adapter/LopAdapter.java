...
public class LopAdapter extends BaseAdapter implements Filterable {
    Activity context;
    int layout;
    ArrayList<Lop> dslop;//luu các doi tuong
...
//khoi tao doi tuong
    ...
    @Override
    public int getCount() {
        return dslop.size();//trả ra số dọc được adapter vẻ toàn bộ
    ...
    //Truy cap cac phan tu cua danh sach
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            LayoutInflater inflater = ((Activity) context).getLayoutInflater();//chuyển layout file XML thành View Object trong Android
        ...
        holder.ivEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LayoutInflater inflater = ((Activity) context).getLayoutInflater();// Gọi layoutInflater ra để bắt đầu ánh xạ view và data.
                View view = inflater.inflate(R.layout.edit_lop, null);// Đổ dữ liệu vào biến View, view này chính là những gì nằm trong editlop.xml
                ...
                btnSua.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            ...
                            ex.printStackTrace();//theo dõi ngoại lệ
                        }
                    }
                });
            }
                ...
                builder.setNegativeButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (lopDao.delete(lop.getMaLop())) {
                            ...
                            dslop.clear();
                            dslop.addAll(lopDao.getAll());
                            notifyDataSetChanged();// update lại data
                            dialog.dismiss();
                        } else {
        ...
        holder.imageViewhinh.setImageResource(R.drawable.logoqnu);
        return convertView;
    }
}
